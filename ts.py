...
def obj(api,method,flag = False):
    ...
    if method == "post":
        header["X-Object-Meta-Color"] = "blu"
...
def temUrl(api,method):
    header = {"X-Auth-Token":USER_TOKEN,"X-Account-Meta-Temp-URL-Key":"qwertyuiop"}
...
class TesRgwApi(unittest.TestCase):
    ...
    def test_03_create_obj(self):
        self.assertEqual(obj("swift/v1/register_0/test.txt","put"),200)
    ...
    def test_05_acl_contain(self):
        self.assertEqual(contain("swift/v1/register_1","post"),200)
        
    """
    Add/Update Container Metadata
    """
    def test_06_meta_contain(self):
        self.assertEqual(contain("swift/v1/register_0","post",True),200)
        
    """
    Copy an Object
    """
    def test_07_copy_obj(self):
        self.assertEqual(obj("swift/v1/register_1/test.txt","put"),200)
    ...
    def test_10_update_obj_meta(self):
        self.assertEqual(obj("swift/v1/register_1/test.txt","post"),200)
    ...
    def test_11_temurl(self):
        self.assertEqual(temUrl("swift/v1","post"),200)
    ...
    def test_12_del_obj(self):
        self.assertEqual(obj("swift/v1/register_1/test.txt","delete"),200)
    ...
    def test_14_del_contain(self):
        self.assertEqual(contain("swift/v1/register_0","delete"),200)
...
if __name__ == "__main__":
    ...
    if info[1] == 404:
        info = user("uid=Swift_api&display-name=swift","put",True)
    elif info[1] == 200:
        ...
        if swift_access:
            ...
            info = user("uid=Swift_api&subuser=swift_id&access=full","put",True)
            if info[1] != 200:
                sys.exit(1)
            USER = swift_access[0]["user"]
            USER_SECRET_KEY = swift_access[0]["secret_key"]
    ...
    #unittest.main()
    auth("auth","get")
    #print contain("swift/v1/register_0","put")
    #print obj("swift/v1/register_0/test.txt","put")
    #print contain("swift/v1/register_0","post")
    #print contain("swift/v1/register_0","post",True)
    #print obj("swift/v1/regiseter_1/test.txt","put")
    #print obj("swift/v1/regiseter_1/test.txt","head")
    #print obj("swift/v1/regiseter_1/test.txt","post")
    print temUrl("swift/v1","post")
    print temObjUrl("/v1/my_names/test.txt","get")
