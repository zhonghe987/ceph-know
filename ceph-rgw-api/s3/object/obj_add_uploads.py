...
hstr += '\n'
hstr += timestr + '\n'
hstr += '/my_1bucket/cae.conf?partNumber=2&uploadId=2~PI9U_WiU3UL2HscC8q5PqNtnQBovBG9'
print('hstr:%s' % (hstr,))
...
with open("/root/kk.tar.gz","r") as  f:
     contetn = f.read()
...
req = requests.put(url = 'http://192.168.205.43:80/my_1bucket/cae.conf?partNumber=2&uploadId=2~PI9U_WiU3UL2HscC8q5PqNtnQBovBG9',
