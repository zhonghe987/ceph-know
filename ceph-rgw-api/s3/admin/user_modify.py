...
#req = requests.Request(url = 'http://192.168.205.43/admin/user?uid=eleme',
#            method = 'GET',
#            headers = {"Host":"192.168.205.43:80","Date":timestr,"Authorization":aws},
#            )
req = requests.post(url = 'http://192.168.205.43/admin/user?uid=eleme&display-name=eleme.modify',headers = header)
#r =  req.prepare()
#s = requests.Session()
#print s.send(r)
print req.json()
