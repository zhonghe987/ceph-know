...
def s3_bucket(api,method,flag = False,ids = False):
    header,data = {},''
    if method == "put":
        if flag:
...
class TesRgwApi(unittest.TestCase):
    ...
    """
    def test_04_s3_set_bucket_version(self):
        self.assertEqual(s3_bucket("s3_object_bucket_0?versioning","put",True),200)
           
    """
    List Buckets
    GET /
    """  
    def test_05_s3_list_bucket(self):
    ...
    PUT /{bucket}/{object}
    """
    def test_06_s3_create_obj(self):
        for i in range(10):
    ...
    GET /{bucket}?location
    """
    def test_07_s3_location_bucket(self):
    ...
    """
    def test_08_s3_list_obj(self):
        self.assertEqual(s3_bucket("s3_object_bucket_0","get"),200)
        
    def test_09_s3_list_objLimit(self):
    ...
    GET /{bucket}?versions
    """
    def test_12_s3_get_version(self):
    ...
    HEAD /{bucket}/{object}
    """
    def test_16_s3_head_obInfo(self):
    ...
    """
    def test_17_s3_get_objAcl(self):
    ...
    GET /{bucket}?uploads
    """
    def test_20_s3_get_upload(self):
    ...
    @subuser
    """
    def test_26_modify_subuser(self):
    ...
    """
    def test_28_get_buckets(self):
        self.assertEqual(bucket("uid=s3_api&stats=True","get"),200)
        
    def test_29_get_bucket(self):
    ...
    @bucket
    """
    def test_30_get_bucket_index(self):
    ...
    @uid
    """
    def test_35_get_user_quota(self):
    ...
    @uid
    """
    def test_36_set_user_quota(self):
    ...
    @uid
    """
    def test_37_get_bucket_quota(self):
    ...
    @uid
    """
    def test_38_set_bucket_quota(self):
    ...
    """
    def test_39_s3_get_obj_id(self):
    ...
    """
    def test_40_s3_head_obInfo_Id(self):
        code,info = s3_bucket("s3_object_bucket_0?versions&prefix=test_0","get",ids = True)
        if code != 200:
    ...
    """
    def test_41_s3_get_objAcl_Id(self):
        code,info = s3_bucket("s3_object_bucket_0?versions&prefix=test_0","get",ids = True)
        if code != 200:
            self.assertEqual(code,200)
        else:
    ...
    @uid
    """
    def test_42_unlink_bucket(self):
        self.assertEqual(bucket("bucket=s3_object_bucket_3&uid=s3_api","post"),200)
    ...
    @uid
    """
    def test_43_link_bucket(self):
        content =  bucket("bucket=s3_object_bucket_3&stats=True","get",True)
        if content[0] == 200:
            ids = content[1]["id"]
            self.assertEqual(bucket("uid=s3_api&bucket=s3_object_bucket_3&bucket-id=%s"%ids,"put"),200)
        else:
    ...
    DELETE /{bucket}
    """
    def test_45_s3_delete_bucket(self):
        self.assertEqual(s3_bucket("s3_object_bucket_4","delete"),204)
    ...
    @bucket
    """
    def test_46_delete_bucke(self):
        for i in range(4):
            self.assertEqual(bucket("bucket=s3_object_bucket_%s&purge-objects=True"%i,"delete"),200)
    
    """
    Remove usage information. With no dates specified, removes all usage information.\
    DELETE /admin/usage?format=json HTTP/1.1 
    """
    def test_47_del_usage(self):
    ...
    @subuser
    """
    def test_48_delete_subuser(self):
